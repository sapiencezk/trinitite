...
/*
 * I3 L1 production admission for the lite-node NockApp host.
 ...
 * Per-slam numbers are the jetted R1 golden with headroom; the probe slams
 * unlimited and RESULTS records the measured use against these bounds.
 */
