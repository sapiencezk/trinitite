...
int m37_a_r_target_forward_provider(uint64_t type,uint64_t value,uint64_t sequence){return candidate_execution_core_r_forward_provider(type,value,sequence);}
