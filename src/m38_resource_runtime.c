...
#define WAVE_RUNTIME_CONTROL_BYTES       (64u * 1024u)
#define WAVE_RUNTIME_WORKSPACE_BYTES     (4u * 1024u * 1024u)
#define WAVE_RUNTIME_BYTES               (WAVE_RUNTIME_CONTROL_BYTES + WAVE_RUNTIME_WORKSPACE_BYTES)
#define WAVE_SESSION_BYTES               (2u * 1024u * 1024u)
#define WAVE_STORAGE_ALIGNMENT           64u
#define WAVE_MAX_ADMISSION_ENTRIES       2u
#define WAVE_MAX_LIVE_HANDLES            8u
#define WAVE_MAX_REGISTERED_SESSIONS     2u
#define WAVE_MAX_CORE_JAM_BYTES          (128u * 1024u)
#define WAVE_MAX_RECORD_JAM_BYTES        (128u * 1024u)
#define WAVE_MAX_CUE_DEPTH               256u
#define WAVE_MAX_CELLS                    128000u
#define WAVE_MAX_NODES                    131072u
#define WAVE_MAX_PLAN_TYPES               8u
#define WAVE_MAX_PLAN_EVENTS              16u
#define WAVE_MAX_PLAN_VALUES              16u
#define WAVE_MAX_PLAN_STATES              8u
#define WAVE_MAX_PLAN_INSTANCES           8u
#define WAVE_MAX_VALUES                    16u
#define WAVE_MAX_SNAPSHOT_NONCE            0xFFFFFFFFULL

#define WAVE_RUNTIME_PLAN_TAG             0x6e616c702d3833ULL
#define WAVE_RUNTIME_STATE_TAG            0x65746174732d3833ULL
#define WAVE_RUNTIME_STIMULUS_TAG         0x6c756d6974732d3833ULL
#define WAVE_RUNTIME_QUEUE_LIMIT          8u
#define WAVE_RUNTIME_WORKLIST_LIMIT       32u
#define WAVE_RUNTIME_TRACE_LIMIT          128u

#define WAVE_SAFETY_SEEN_OFFSET           0u
#define WAVE_SAFETY_COLOR_OFFSET          (WAVE_MAX_NODES * sizeof(uint32_t))
#define WAVE_SAFETY_STACK_OFFSET          (WAVE_SAFETY_COLOR_OFFSET + WAVE_MAX_NODES)
#define WAVE_SAFETY_DEPTH_OFFSET          (WAVE_SAFETY_STACK_OFFSET + WAVE_MAX_NODES * sizeof(noun))
#define WAVE_SAFETY_WORK_OFFSET           (WAVE_SAFETY_DEPTH_OFFSET + WAVE_MAX_NODES * sizeof(uint32_t))
#define WAVE_SAFETY_WORK_BYTES            (WAVE_RUNTIME_WORKSPACE_BYTES - WAVE_SAFETY_WORK_OFFSET)

#define WAVE_OP_LOAD                      1u
#define WAVE_OP_POKE                      2u
#define WAVE_OP_PEEK                      3u
#define WAVE_OP_SNAPSHOT                  4u
#define WAVE_OP_RESTORE                   5u

#define WAVE_WIRE_LOADED                  1u
#define WAVE_WIRE_POKE                    2u
#define WAVE_WIRE_PEEK                    3u
#define WAVE_WIRE_SNAPSHOT                4u
#define WAVE_WIRE_RESTORE                 5u
#define WAVE_WIRE_REFUSE                  255u

#define WAVE_REASON_INVALID_REQUEST       1u
#define WAVE_REASON_UNKNOWN_CORE          2u
#define WAVE_REASON_BAD_HANDLE            3u
#define WAVE_REASON_BAD_STIMULUS          4u
#define WAVE_REASON_BAD_SELECTOR          5u
#define WAVE_REASON_BAD_SNAPSHOT          6u
#define WAVE_REASON_CONSTRUCTION          7u
#define WAVE_REASON_CORE_FAILURE          8u
#define WAVE_REASON_NO_SLOT               9u

static const char WAVE_REQUEST_TAG[] = "m38-resource-abi-v1-request";
static const char WAVE_REQUEST_SCHEMA[] = "m38-resource-abi-v1-request-schema-v1";
static const char WAVE_RESULT_TAG[] = "m38-resource-abi-v1-result";
static const char WAVE_RESULT_SCHEMA[] = "m38-resource-abi-v1-result-schema-v1";
static const char WAVE_STIMULUS_TAG[] = "m38-resource-abi-v1-numeric-stimulus";
static const char WAVE_STIMULUS_SCHEMA[] = "m38-resource-abi-v1-numeric-stimulus-schema-v1";
static const char WAVE_SELECTOR_TAG[] = "m38-resource-abi-v1-numeric-selector";
static const char WAVE_SELECTOR_SCHEMA[] = "m38-resource-abi-v1-numeric-selector-schema-v1";
static const char WAVE_STATE_TAG[] = "m38-resource-abi-v1-numeric-state";
static const char WAVE_STATE_SCHEMA[] = "m38-resource-abi-v1-numeric-state-schema-v1";
static const char WAVE_INSTANCE_TAG[] = "m38-resource-abi-v1-instance-state";
static const char WAVE_INSTANCE_SCHEMA[] = "m38-resource-abi-v1-instance-state-schema-v1";
static const char WAVE_VALUE_TAG[] = "m38-resource-abi-v1-numeric-value";
static const char WAVE_VALUE_SCHEMA[] = "m38-resource-abi-v1-numeric-value-schema-v1";
static const char WAVE_EFFECTS_TAG[] = "m38-resource-abi-v1-numeric-effects";
static const char WAVE_EFFECTS_SCHEMA[] = "m38-resource-abi-v1-numeric-effects-schema-v1";
static const char WAVE_OBSERVATIONS_TAG[] = "m38-resource-abi-v1-numeric-observations";
static const char WAVE_OBSERVATIONS_SCHEMA[] = "m38-resource-abi-v1-numeric-observations-schema-v1";
static const char WAVE_OBSERVATION_TAG[] = "m38-resource-abi-v1-numeric-observation";
static const char WAVE_OBSERVATION_SCHEMA[] = "m38-resource-abi-v1-numeric-observation-schema-v1";
static const char WAVE_METRICS_TAG[] = "m38-resource-abi-v1-numeric-metrics";
static const char WAVE_METRICS_SCHEMA[] = "m38-resource-abi-v1-numeric-metrics-schema-v1";
static const char WAVE_RECEIPT_TAG[] = "m38-resource-abi-v1-restore-receipt";
static const char WAVE_RECEIPT_SCHEMA[] = "m38-resource-abi-v1-restore-receipt-schema-v1";
static const char WAVE_REFUSAL_TAG[] = "m38-resource-abi-v1-refusal-reason";
static const char WAVE_REFUSAL_SCHEMA[] = "m38-resource-abi-v1-refusal-reason-schema-v1";
static const char WAVE_ZERO_TAG[] = "m38-resource-abi-v1-zero-state";
static const char WAVE_ZERO_SCHEMA[] = "m38-resource-abi-v1-zero-state-schema-v1";
static const char WAVE_RECORD_TAG[] = "m38-resource-abi-v1-session-admission-record";
static const char WAVE_RECORD_SCHEMA[] = "m38-resource-abi-v1-session-admission-record-schema-v1";
static const char WAVE_ADMISSION_DOMAIN[] = "1499kernel:i2:m38:resource-abi-v1:session-admission-record:v1";
static const char WAVE_CORE_DOMAIN[] = "1499kernel:i2:m38-d0-r3:resource-core:v3";
static const char WAVE_FORMULA_DOMAIN[] = "1499kernel:i2:m38-d0-r3:formula:v3";
static const char WAVE_PAYLOAD_DOMAIN[] = "1499kernel:i2:m38-d0-r3:resource-payload:v3";
static const char WAVE_PROFILE_ID[] = "1499kernel-i2-m38-numeric-execution-profile-v1-bounded";

static const char *const WAVE_BINDING_NAMES[15] = {
...
static const char *const WAVE_BINDING_TAGS[15] = {
...
static const char *const WAVE_BINDING_SCHEMAS[15] = {
...
static const char *const WAVE_NESTED_SCHEMAS[13] = {
...
static const uint8_t WAVE_CORE_IDS[2][32] = {
...
static const uint8_t WAVE_BATTERY_IDS[2][32] = {
...
static const uint8_t WAVE_PAYLOAD_IDS[2][32] = {
...
static const uint8_t WAVE_ADMISSION_IDS[2][32] = {
...
typedef struct WavePlanType {
    ...
    uint32_t state_id;
    uint32_t value_ids[WAVE_MAX_PLAN_VALUES];
    uint32_t value_types[WAVE_MAX_PLAN_VALUES];
    uint32_t value_initials[WAVE_MAX_PLAN_VALUES];
    uint32_t event_count;
    uint32_t event_ids[WAVE_MAX_PLAN_EVENTS];
    uint32_t event_value_counts[WAVE_MAX_PLAN_EVENTS];
    uint32_t event_value_ids[WAVE_MAX_PLAN_EVENTS][WAVE_MAX_PLAN_VALUES];
...
typedef struct WavePlan {
    ...
    uint32_t instance_types[WAVE_MAX_PLAN_INSTANCES];
    WavePlanType types[WAVE_MAX_PLAN_TYPES];
    noun formula;
    noun payload;
} WavePlan;
...
typedef struct WaveSlot {
    ...
    noun state_root;
    noun snapshot_root;
    uint32_t state_ids[WAVE_MAX_PLAN_INSTANCES];
    uint32_t state_values[WAVE_MAX_PLAN_INSTANCES][WAVE_MAX_PLAN_VALUES];
} WaveSlot;
...
typedef struct WaveCatalogCopy {
    ...
    uint8_t core_jam[WAVE_MAX_CORE_JAM_BYTES];
    noun core;
} WaveCatalogCopy;
...
struct ResourceSession {
    ...
    WaveCatalogCopy catalog[WAVE_MAX_ADMISSION_ENTRIES];
    WaveCacheEntry cache[WAVE_MAX_ADMISSION_ENTRIES];
    WaveSlot slots[WAVE_MAX_LIVE_HANDLES];
    noun primary_root;
    noun refusal_root;
...
struct ResourceRuntime {
    ...
    ResourceSession *sessions[WAVE_MAX_REGISTERED_SESSIONS];
};

#define WAVE_RUNTIME_MAGIC  0x52333857u
#define WAVE_SESSION_MAGIC  0x53333857u
...
{
    noun row[1 + WAVE_MAX_VALUES];
    if (count >= 1 + WAVE_MAX_VALUES) return 0;
                              ...
                              const char *domain, uint8_t digest[32])
{
    ...
    if (jam_encode_bytes_identity_bounded(value, &jammed, &jam_bytes, &budget) != 0
        || jam_bytes > WAVE_MAX_CORE_JAM_BYTES)
        return 0;
    size_t domain_bytes = wave_strlen(domain);
    if (domain_bytes + 1u + jam_bytes > WAVE_SAFETY_WORK_BYTES)
        return 0;
    uint8_t *preimage = (uint8_t *)runtime->workspace + WAVE_SAFETY_WORK_OFFSET;
                            ...
                            uint32_t *slot, int *found)
{
    ...
    for (uint32_t probe = 0; probe < WAVE_MAX_NODES; probe++) {
        uint32_t i = (h + probe) & (WAVE_MAX_NODES - 1u);
        if (keys[i] == 0) {
            keys[i] = key;
            colors[i] = 0;
            *slot = i;
...
static int wave_safe_noun(ResourceRuntime *runtime, noun root)
{
    ...
    uint32_t *keys = (uint32_t *)(workspace + WAVE_SAFETY_SEEN_OFFSET);
    uint8_t *colors = workspace + WAVE_SAFETY_COLOR_OFFSET;
    noun *stack = (noun *)(workspace + WAVE_SAFETY_STACK_OFFSET);
    uint32_t *depths = (uint32_t *)(workspace + WAVE_SAFETY_DEPTH_OFFSET);
    uint8_t *phases = workspace + WAVE_SAFETY_WORK_OFFSET;
    wave_zero(keys, WAVE_MAX_NODES * sizeof(uint32_t));
    wave_zero(colors, WAVE_MAX_NODES);
    ...
    while (top != 0) {
        ...
        if (!noun_is_cell(n)) {
            if (noun_is_indirect(n) && atom_store_get(indirect_hash(n)) == 0)
                return 0;
            if (++nodes > WAVE_MAX_NODES) return 0;
            top--;
            continue;
        }
        if (!wave_cell_active(n) || depth > WAVE_MAX_CUE_DEPTH)
            return 0;
        uint32_t slot;
        int found;
        if (!wave_safety_slot(keys, colors, cell_ptr(n), &slot, &found)) return 0;
        if (!found) {
            if (++nodes > WAVE_MAX_NODES || ++cells > WAVE_MAX_CELLS) return 0;
            colors[slot] = 1;
        ...
        if (phases[index] == 0) {
            phases[index] = 1;
            if (top == WAVE_MAX_NODES) return 0;
            stack[top] = c->head;
            depths[top] = depth + 1u;
            phases[top] = 0;
            top++;
...
static int wave_forward_binding(noun value, uint32_t expected)
{
    ...
    return wave_list(value, fields, 3, &count) && count == 3
        && wave_atom_text(fields[0], WAVE_BINDING_NAMES[expected])
        && wave_atom_text(fields[1], WAVE_BINDING_TAGS[expected])
        && wave_atom_text(fields[2], WAVE_BINDING_SCHEMAS[expected]);
}
                                ...
                                uint8_t admission_id[32])
{
    ...
    if (!wave_pair(record, &tag, &body)
        || !wave_atom_text(tag, WAVE_RECORD_TAG)
        || !wave_record(body, fields, 11)
        || !wave_atom_text(fields[0], WAVE_RECORD_SCHEMA)) {
        return 0;
    }
    uint8_t core_id[32];
    ...
    for (uint32_t i = 0; i < 2; i++)
        if (wave_bytes_equal(core_id, WAVE_CORE_IDS[i], sizeof(core_id))) index = i;
    if (index >= 2) return 0;
    uint32_t core_bytes;
    if (!wave_u(fields[2], WAVE_MAX_CORE_JAM_BYTES, &core_bytes)
    ...
    if (!wave_identity(fields[3], sha)
        || !wave_identity(fields[4], WAVE_BATTERY_IDS[index])
        || !wave_identity(fields[5], WAVE_PAYLOAD_IDS[index])) return 0;
    ...
    if (!wave_atom_text(fields[7], WAVE_PROFILE_ID)
    ...
    for (uint32_t i = 0; i < 13; i++)
        if (!wave_atom_text(nested[i], WAVE_NESTED_SCHEMAS[i])) return 0;
    ...
    if (jam_encode_bytes_identity_bounded(record, &canonical, &canonical_bytes, &budget) != 0
        || canonical_bytes > WAVE_MAX_RECORD_JAM_BYTES)
        return 0;
    size_t domain_bytes = wave_strlen(WAVE_ADMISSION_DOMAIN);
    if (domain_bytes + canonical_bytes > WAVE_SAFETY_WORK_BYTES) return 0;
    uint8_t *preimage = (uint8_t *)runtime->workspace + WAVE_SAFETY_WORK_OFFSET;
    for (size_t i = 0; i < domain_bytes; i++) preimage[i] = (uint8_t)WAVE_ADMISSION_DOMAIN[i];
    ...
    if (!wave_bytes_equal(admission_id, WAVE_ADMISSION_IDS[index], 32)) return 0;
    *catalog_index = index;
    return 1;
}
...
static int wave_parse_plan(noun core, WavePlan *out)
{
    ...
    noun types[WAVE_MAX_PLAN_TYPES], instances[WAVE_MAX_PLAN_INSTANCES];
    ...
    if (!wave_pair(core, &formula, &payload)
        ...
        || !wave_list(semantic[0], types, WAVE_MAX_PLAN_TYPES, &type_count)
        || !wave_list(semantic[1], instances, WAVE_MAX_PLAN_INSTANCES, &instance_count)
    ...
    for (uint32_t i = 0; i < type_count; i++) {
        noun tf[6], events[WAVE_MAX_PLAN_EVENTS], values[WAVE_MAX_PLAN_VALUES];
        noun states[WAVE_MAX_PLAN_STATES];
        uint32_t event_count, value_count, state_count;
        WavePlanType *type = &plan.types[i];
        if (!wave_record(types[i], tf, 6)
            || !wave_u(tf[0], WAVE_MAX_PLAN_TYPES, &type->id)
            || type->id != i + 1u
            || !wave_list(tf[1], events, WAVE_MAX_PLAN_EVENTS, &event_count)
            || !wave_list(tf[2], values, WAVE_MAX_PLAN_VALUES, &value_count)
            || !wave_list(tf[3], states, WAVE_MAX_PLAN_STATES, &state_count)
            || value_count == 0 || state_count == 0)
            return 0;
        type->event_count = event_count;
        for (uint32_t j = 0; j < event_count; j++) {
            noun ef[3];
            noun event_values[WAVE_MAX_PLAN_VALUES];
            ...
            if (!wave_record(events[j], ef, 3)
                ...
                || !wave_list(ef[2], event_values, WAVE_MAX_PLAN_VALUES,
                              &event_value_count))
                return 0;
            type->event_value_counts[j] = event_value_count;
            for (uint32_t k = 0; k < event_value_count; k++)
                if (!wave_u(event_values[k], WAVE_MAX_PLAN_VALUES,
        ...
        for (uint32_t j = 0; j < value_count; j++) {
            ...
            if (!wave_record(values[j], vf, 4)
                || !wave_u(vf[0], WAVE_MAX_PLAN_VALUES, &type->value_ids[j])
        ...
        for (uint32_t j = 0; j < state_count; j++) {
            ...
            if (!wave_record(states[j], sf, 3)
                || !wave_u(sf[0], WAVE_MAX_PLAN_STATES, &id)
    ...
    for (uint32_t i = 0; i < instance_count; i++) {
        ...
        if (!wave_record(instances[i], inf, 2)
            || !wave_u(inf[0], WAVE_MAX_PLAN_INSTANCES, &id)
            || id != i + 1u || !wave_u(inf[1], WAVE_MAX_PLAN_TYPES, &type_id)
                              ...
                              WavePlan *plan)
{
    ...
    uint8_t digest[32];
    if (!wave_domain_digest(runtime, formula, WAVE_FORMULA_DOMAIN, digest)
        || !wave_bytes_equal(digest, expected_battery, sizeof(digest))
        || !wave_domain_digest(runtime, payload, WAVE_PAYLOAD_DOMAIN, digest)
        || !wave_bytes_equal(digest, expected_payload, sizeof(digest))
        || !wave_domain_digest(runtime, core, WAVE_CORE_DOMAIN, digest)
...
typedef struct WaveRootCopies {
    noun catalog[WAVE_MAX_ADMISSION_ENTRIES];
    noun cache_core[WAVE_MAX_ADMISSION_ENTRIES];
    noun cache_formula[WAVE_MAX_ADMISSION_ENTRIES];
    noun cache_payload[WAVE_MAX_ADMISSION_ENTRIES];
    noun state[WAVE_MAX_LIVE_HANDLES];
    noun snapshot[WAVE_MAX_LIVE_HANDLES];
    noun handle[WAVE_MAX_LIVE_HANDLES];
    noun primary;
    noun refusal;
} WaveRootCopies;
...
static int wave_runtime_valid(ResourceRuntime *runtime)
{
    return runtime != 0 && runtime == g_wave_runtime_lease
        && runtime->magic == WAVE_RUNTIME_MAGIC
        && runtime->state != 0;
}

static int wave_session_valid(ResourceSession *session)
{
    return session != 0 && session->magic == WAVE_SESSION_MAGIC
...
static int wave_copy_registered_roots(ResourceRuntime *runtime,
                                      WaveRootCopies copies[WAVE_MAX_REGISTERED_SESSIONS])
{
    int previous_mode = heap_get_mode();
    wave_zero(copies, sizeof(WaveRootCopies) * WAVE_MAX_REGISTERED_SESSIONS);
    heap_set_mode(HEAP_MODE_PERSIST);
    heap_persist_begin_tx();
    for (uint32_t i = 0; i < WAVE_MAX_REGISTERED_SESSIONS; i++) {
        ResourceSession *session = runtime->sessions[i];
        if (!session || session->state != 1) continue;
        for (uint32_t j = 0; j < WAVE_MAX_ADMISSION_ENTRIES; j++)
        ...
        for (uint32_t j = 0; j < WAVE_MAX_LIVE_HANDLES; j++) {
                                ...
                                WavePreflightEntry *out)
{
    ...
    if (!wave_safe_noun(runtime, core)
        || !wave_core_validate(runtime, core, WAVE_CORE_IDS[index],
                               WAVE_BATTERY_IDS[index], WAVE_PAYLOAD_IDS[index],
    ...
    for (uint32_t i = 0; i < 32; i++) {
        out->core_id[i] = WAVE_CORE_IDS[index][i];
        out->battery_id[i] = WAVE_BATTERY_IDS[index][i];
        out->payload_id[i] = WAVE_PAYLOAD_IDS[index][i];
    }
    noun_tx_abort();
    return 1;
}
...
static M38Status wave_catalog_preflight(ResourceRuntime *runtime,
                                        ...
                                        WavePreflightEntry out[WAVE_MAX_ADMISSION_ENTRIES])
{
    if (!catalog || !catalog->entries || catalog->entry_count == 0
        || catalog->entry_count > WAVE_MAX_ADMISSION_ENTRIES)
    ...
    for (uint32_t i = 0; i < catalog->entry_count; i++) {
        ...
        if (!entry->record_jam || !entry->resource_core_jam
            ...
            || entry->record_jam_bytes > WAVE_MAX_RECORD_JAM_BYTES
            || entry->resource_core_jam_bytes > WAVE_MAX_CORE_JAM_BYTES)
...
size_t m38_resource_runtime_storage_bytes(void) { return WAVE_RUNTIME_BYTES; }
size_t m38_resource_runtime_control_storage_bytes(void) { return WAVE_RUNTIME_CONTROL_BYTES; }
size_t m38_resource_runtime_init_workspace_bytes(void) { return WAVE_RUNTIME_WORKSPACE_BYTES; }
size_t m38_resource_runtime_storage_alignment(void) { return WAVE_STORAGE_ALIGNMENT; }
size_t m38_resource_session_storage_bytes(void) { return WAVE_SESSION_BYTES; }
size_t m38_resource_session_storage_alignment(void) { return WAVE_STORAGE_ALIGNMENT; }
    ...
    const SupervisorAdmissionEntry *entries, uint32_t entry_count)
{
    ...
    if (!entries || entry_count == 0 || entry_count > WAVE_MAX_ADMISSION_ENTRIES)
        return M38_STATUS_CATALOG_INVALID;
    ...
    for (uint32_t i = 0; i < entry_count; i++) {
        if (!entries[i].record_jam || !entries[i].resource_core_jam
            ...
            return M38_STATUS_CATALOG_BOUNDS;
        if (entries[i].record_jam_bytes > WAVE_MAX_RECORD_JAM_BYTES
            || entries[i].resource_core_jam_bytes > WAVE_MAX_CORE_JAM_BYTES)
            return M38_STATUS_CATALOG_BOUNDS;
...
static int wave_promote_registration(ResourceRuntime *runtime,
                                     const SupervisorAdmissionCatalog *catalog,
                                     const WavePreflightEntry pre[WAVE_MAX_ADMISSION_ENTRIES],
                                     noun new_cores[WAVE_MAX_ADMISSION_ENTRIES])
{
    WaveRootCopies copies[WAVE_MAX_REGISTERED_SESSIONS];
    wave_zero(copies, sizeof(copies));
    wave_zero(new_cores, sizeof(noun) * WAVE_MAX_ADMISSION_ENTRIES);
    heap_set_mode(HEAP_MODE_PERSIST);
    heap_persist_begin_tx();
    for (uint32_t i = 0; i < WAVE_MAX_REGISTERED_SESSIONS; i++) {
        ResourceSession *session = runtime->sessions[i];
    ...
    for (uint32_t i = 0; i < catalog->entry_count; i++) {
        ...
        if (!wave_safe_noun(runtime, new_cores[i])
            || !wave_core_validate(runtime, new_cores[i], WAVE_CORE_IDS[pre[i].catalog_index],
                                   WAVE_BATTERY_IDS[pre[i].catalog_index],
                                   WAVE_PAYLOAD_IDS[pre[i].catalog_index],
                                        ...
                                        ResourceRuntime *runtime)
{
    if (wave_range_overlap(catalog, sizeof(*catalog), storage, storage_bytes)
        ...
        || wave_range_overlap(catalog, sizeof(*catalog), runtime->control_storage,
                              WAVE_RUNTIME_CONTROL_BYTES)
        || wave_range_overlap(catalog, sizeof(*catalog), runtime->workspace,
                              WAVE_RUNTIME_WORKSPACE_BYTES)
        || wave_range_overlap(catalog->entries,
                              catalog->entry_count * sizeof(*catalog->entries),
                              runtime->control_storage, WAVE_RUNTIME_CONTROL_BYTES)
        || wave_range_overlap(catalog->entries,
                              catalog->entry_count * sizeof(*catalog->entries),
                              runtime->workspace, WAVE_RUNTIME_WORKSPACE_BYTES))
        return 1;
    for (uint32_t i = 0; i < catalog->entry_count; i++)
    ...
    ResourceSession **out_session, SessionCapability *out_capability)
{
    ...
    *out_capability = 0;
    ...
    if (storage_bytes < WAVE_SESSION_BYTES) return M38_STATUS_STORAGE_TOO_SMALL;
    if (((uintptr_t)storage & (WAVE_STORAGE_ALIGNMENT - 1u)) != 0)
        return M38_STATUS_STORAGE_MISALIGNED;
    if (catalog->entry_count == 0 || catalog->entry_count > WAVE_MAX_ADMISSION_ENTRIES
        || !catalog->entries)
        return M38_STATUS_CATALOG_INVALID;
    if (wave_catalog_aliases_storage(catalog, storage, WAVE_SESSION_BYTES, runtime))
        return M38_STATUS_STORAGE_OVERLAP;
    if (runtime->broker_owner != 0 || runtime->state == 3)
        return M38_STATUS_RUNTIME_BUSY;
    if (runtime->session_count >= WAVE_MAX_REGISTERED_SESSIONS)
        return M38_STATUS_SESSION_REGISTRY_FULL;
    runtime->broker_owner = 3;
    runtime->state = 4;

    WavePreflightEntry pre[WAVE_MAX_ADMISSION_ENTRIES] = {{0}};
    ...
    while (registry_index < WAVE_MAX_REGISTERED_SESSIONS
           && runtime->sessions[registry_index] != 0)
        registry_index++;
    if (registry_index >= WAVE_MAX_REGISTERED_SESSIONS) {
        wave_broker_release(runtime);
        return M38_STATUS_SESSION_REGISTRY_FULL;
    }
    ResourceSession *session = (ResourceSession *)storage;
    wave_zero(session, sizeof(*session));
    session->magic = WAVE_SESSION_MAGIC;
    session->state = 1;
    ...
    for (uint32_t i = 0; i < WAVE_MAX_LIVE_HANDLES; i++)
    ...
    ResourceRuntime **out_runtime)
{
    ...
    *out_runtime = 0;
    ...
    if (control_storage_bytes < WAVE_RUNTIME_CONTROL_BYTES
        || init_workspace_bytes < WAVE_RUNTIME_WORKSPACE_BYTES)
        return M38_STATUS_STORAGE_TOO_SMALL;
    if (((uintptr_t)control_storage & (WAVE_STORAGE_ALIGNMENT - 1u)) != 0
        || ((uintptr_t)init_workspace & (WAVE_STORAGE_ALIGNMENT - 1u)) != 0)
        return M38_STATUS_STORAGE_MISALIGNED;
    if (wave_range_overlap(control_storage, WAVE_RUNTIME_CONTROL_BYTES,
                           init_workspace, WAVE_RUNTIME_WORKSPACE_BYTES)
        || wave_range_overlap(out_runtime, sizeof(*out_runtime),
                              control_storage, WAVE_RUNTIME_CONTROL_BYTES)
        || wave_range_overlap(out_runtime, sizeof(*out_runtime),
                              init_workspace, WAVE_RUNTIME_WORKSPACE_BYTES))
        return M38_STATUS_STORAGE_OVERLAP;
                             ...
                             noun *out)
{
    ...
    if (catalog_index >= WAVE_MAX_ADMISSION_ENTRIES
        || !wave_digest_atom(session->catalog[catalog_index].admission_id, &admission))
        return 0;
    if (!wave_capability_atom(session->capability, &fields[0])) return 0;
    fields[1] = direct(slot);
    fields[2] = direct(generation);
    fields[3] = admission;
...
static int wave_value_build(uint32_t id, uint32_t type, uint32_t value, noun *out)
{
    ...
    return wave_build_tagged(WAVE_VALUE_TAG, WAVE_VALUE_SCHEMA, fields, 3, out);
}
...
static int wave_state_build(const ResourceSession *session, const WavePlan *plan,
                            ...
                            noun *out)
{
    noun instances[WAVE_MAX_PLAN_INSTANCES];
    for (uint32_t i = plan->instance_count; i != 0; i--) {
        ...
        noun values[WAVE_MAX_PLAN_VALUES];
        ...
        if (!wave_build_tagged(WAVE_INSTANCE_TAG, WAVE_INSTANCE_SCHEMA,
    ...
    noun fields[3] = {admission, wave_cord(WAVE_PROFILE_ID), instance_list};
    return wave_build_tagged(WAVE_STATE_TAG, WAVE_STATE_SCHEMA, fields, 3, out);
}

static int wave_zero_state_build(noun *out)
{
    noun fields[1] = {NOUN_ZERO};
    return wave_build_tagged(WAVE_ZERO_TAG, WAVE_ZERO_SCHEMA, fields, 1, out);
}

static int wave_refusal_build(uint32_t reason, noun *out)
{
    noun reason_fields[2] = {direct(reason), wave_cord("wave-a refusal")};
    noun reason_noun;
    noun zero_state;
    noun body_fields[2];
    if (!wave_build_tagged(WAVE_REFUSAL_TAG, WAVE_REFUSAL_SCHEMA,
    ...
    noun result_fields[2] = {direct(WAVE_WIRE_REFUSE), body};
    return wave_build_tagged(WAVE_RESULT_TAG, WAVE_RESULT_SCHEMA,
                              result_fields, 2, out);
}
...
{
    noun fields[1] = {NOUN_ZERO};
    return wave_build_tagged(WAVE_EFFECTS_TAG, WAVE_EFFECTS_SCHEMA, fields, 1, out);
}

static int wave_empty_observations(noun *out)
{
    noun fields[1] = {NOUN_ZERO};
    return wave_build_tagged(WAVE_OBSERVATIONS_TAG, WAVE_OBSERVATIONS_SCHEMA, fields, 1, out);
}
...
static int wave_metrics_build(uint64_t ops, uint64_t cells, uint64_t stack, noun *out)
{
    ...
    return wave_build_tagged(WAVE_METRICS_TAG, WAVE_METRICS_SCHEMA, fields, 5, out);
}

static int wave_result_build(uint32_t status, noun body, noun *out)
{
    noun fields[2] = {direct(status), body};
    return wave_build_tagged(WAVE_RESULT_TAG, WAVE_RESULT_SCHEMA, fields, 2, out);
}
                              ...
                              uint32_t *slot_out)
{
    ...
    if (!wave_record(value, fields, 4)
        ...
        || !wave_u(fields[1], WAVE_MAX_LIVE_HANDLES, &slot)
        || slot == 0
        || !wave_u(fields[2], 0xFFFFFFFFu, &generation)
        || generation == 0
...
static int wave_stimulus_validate(const WavePlan *plan, noun stimulus)
{
    ...
    if (!wave_pair(stimulus, &tag, &body)
        || !wave_atom_text(tag, WAVE_STIMULUS_TAG)
        || !wave_record(body, fields, 3)
        || !wave_atom_text(fields[0], WAVE_STIMULUS_SCHEMA)
        || !wave_u(fields[1], 0xFFFF, &event) || event == 0
        || !wave_plan_has_event(plan, event)
        || !wave_list(fields[2], values, WAVE_MAX_VALUES, &count))
        return 0;
    for (uint32_t i = 0; i < count; i++) {
        noun vf[4];
        uint32_t id, type, raw;
        if (!wave_pair(values[i], &tag, &body)
            || !wave_atom_text(tag, WAVE_VALUE_TAG)
            || !wave_record(body, vf, 4)
            || !wave_atom_text(vf[0], WAVE_VALUE_SCHEMA)
                                  ...
                                  uint32_t *target_out)
{
    ...
    if (!wave_pair(selector, &tag, &body)
        || !wave_atom_text(tag, WAVE_SELECTOR_TAG)
        || !wave_record(body, fields, 2)
        || !wave_atom_text(fields[0], WAVE_SELECTOR_SCHEMA)
...
static int wave_request_decode(noun request, WaveRequest *out)
{
    ...
    if (!wave_pair(request, &tag, &body)
        || !wave_atom_text(tag, WAVE_REQUEST_TAG)
        || !wave_record(body, fields, 3)
        || !wave_atom_text(fields[0], WAVE_REQUEST_SCHEMA)
        || !wave_u(fields[1], WAVE_OP_RESTORE, &out->operation))
        return 0;
    out->first = NOUN_ZERO;
    out->second = NOUN_ZERO;
    if (out->operation == WAVE_OP_LOAD || out->operation == WAVE_OP_SNAPSHOT) {
        out->first = fields[2];
        return 1;
    }
                           ...
                           noun core, uint32_t *index_out)
{
    ...
    if (jam_encode_bytes_identity_bounded(core, &canonical, &bytes, &budget) != 0
        || bytes == 0 || bytes > WAVE_MAX_CORE_JAM_BYTES)
        return 0;
    if (!wave_domain_digest(runtime, core, WAVE_CORE_DOMAIN, identity)) return 0;
    for (uint32_t i = 0; i < WAVE_MAX_ADMISSION_ENTRIES; i++) {
                                  ...
                                  noun *out)
{
    ...
    return wave_build_tagged(WAVE_OBSERVATION_TAG, WAVE_OBSERVATION_SCHEMA,
                             fields, 2, out);
}
                               ...
                               noun *snapshot_out)
{
    ...
    if (!wave_handle_build(session, slot_index + 1u, slot->generation,
        ...
        return 0;
    noun fields[3] = {*handle_out, *state_out, direct(slot->snapshot_nonce)};
                               ...
                               noun snapshot, uint32_t slot_index, WaveSlot *out_slot)
{
    ...
    if (slot_index >= WAVE_MAX_LIVE_HANDLES || !session->slots[slot_index].used
        || session->slots[slot_index].catalog_index >= WAVE_MAX_ADMISSION_ENTRIES
    ...
    for (uint32_t i = 0; i < instance_count; i++) {
        ...
        if (!wave_pair(instances[i], &instance_tag, &instance_body)
            || !wave_atom_text(instance_tag, WAVE_INSTANCE_TAG)
            || !wave_record(instance_body, instance_fields, 4)
            || !wave_atom_text(instance_fields[0], WAVE_INSTANCE_SCHEMA)
            || !wave_u(instance_fields[1], WAVE_MAX_PLAN_INSTANCES, &instance)
            || instance == 0 || instance > plan->instance_count || seen[instance - 1u]
            || !wave_u(instance_fields[2], WAVE_MAX_PLAN_STATES, &state_id)) return 0;
        ...
        noun values[WAVE_MAX_PLAN_VALUES];
        if (!wave_list(instance_fields[3], values, WAVE_MAX_PLAN_VALUES, &value_count)
        ...
        for (uint32_t j = 0; j < value_count; j++) {
            ...
            if (!wave_pair(values[j], &value_tag, &value_body)
                || !wave_atom_text(value_tag, WAVE_VALUE_TAG)
                || !wave_record(value_body, value_fields, 4)
                || !wave_atom_text(value_fields[0], WAVE_VALUE_SCHEMA)
                || !wave_u(value_fields[1], WAVE_MAX_PLAN_VALUES, &value_id)
...
{
    noun rows[WAVE_MAX_PLAN_INSTANCES];
    noun identity;
    ...
    return alloc_cell_checked(direct(WAVE_RUNTIME_STATE_TAG), body, out);
}
...
{
    noun tag, body, fields[3], values[WAVE_MAX_PLAN_VALUES];
    uint32_t value_count, event;
    if (!wave_pair(stimulus, &tag, &body)
        || !wave_record(body, fields, 3)
        || !wave_u(fields[1], 0xFFFF, &event)
        || !wave_list(fields[2], values, WAVE_MAX_PLAN_VALUES, &value_count)) return 0;
    uint32_t type_index = WAVE_MAX_PLAN_TYPES;
    uint32_t event_index = WAVE_MAX_PLAN_EVENTS;
    for (uint32_t i = 0; i < plan->type_count; i++) {
        for (uint32_t j = 0; j < plan->types[i].event_count; j++) {
        ...
        if (type_index != WAVE_MAX_PLAN_TYPES) break;
    }
    if (type_index == WAVE_MAX_PLAN_TYPES) return 0;
    uint32_t instance = WAVE_MAX_PLAN_INSTANCES;
    for (uint32_t i = 0; i < plan->instance_count; i++)
        if (plan->instance_types[i] == type_index + 1u) {
            instance = i;
            break;
        }
    if (instance == WAVE_MAX_PLAN_INSTANCES
        || value_count != plan->types[type_index].event_value_counts[event_index]) return 0;

    noun runtime_values[WAVE_MAX_PLAN_VALUES];
    for (uint32_t i = 0; i < value_count; i++) {
        ...
        uint32_t value_id;
        if (!wave_u(value_fields[1], WAVE_MAX_PLAN_VALUES, &value_id)
...
{
    noun fields[3] = {direct(WAVE_RUNTIME_QUEUE_LIMIT),
                      direct(WAVE_RUNTIME_WORKLIST_LIMIT),
                      direct(WAVE_RUNTIME_TRACE_LIMIT)};
    noun limits;
                                       ...
                                       noun product, WaveSlot *slot)
{
    ...
    noun state_tag, state_body, state_fields[2], rows[WAVE_MAX_PLAN_INSTANCES];
    uint32_t row_count;
    if (!wave_pair(fields[2], &state_tag, &state_body)
        || !noun_is_direct(state_tag) || direct_val(state_tag) != WAVE_RUNTIME_STATE_TAG
        || !wave_record(state_body, state_fields, 2)
        || !wave_identity(state_fields[0], session->catalog[catalog_index].payload_id)
        || !wave_list(state_fields[1], rows, WAVE_MAX_PLAN_INSTANCES, &row_count)
        || row_count != plan->instance_count) return 0;

    WaveSlot candidate = *slot;
    uint8_t seen[WAVE_MAX_PLAN_INSTANCES] = {0};
    for (uint32_t i = 0; i < row_count; i++) {
        noun row_fields[3], values[WAVE_MAX_PLAN_VALUES];
        uint32_t instance, state_id, value_count;
        if (!wave_record(rows[i], row_fields, 3)
            || !wave_u(row_fields[0], WAVE_MAX_PLAN_INSTANCES, &instance)
            || instance == 0 || instance > plan->instance_count || seen[instance - 1u]
            || !wave_u(row_fields[1], WAVE_MAX_PLAN_STATES, &state_id)
            || state_id == 0
            || !wave_list(row_fields[2], values, WAVE_MAX_PLAN_VALUES, &value_count)) return 0;
        uint32_t instance_index = instance - 1u;
        const WavePlanType *type = &plan->types[plan->instance_types[instance_index] - 1u];
        ...
        for (uint32_t j = 0; j < value_count; j++) {
            ...
            if (!wave_record(values[j], value_fields, 3)
                || !wave_u(value_fields[0], WAVE_MAX_PLAN_VALUES, &value_id)
                || value_id != type->value_ids[j]
                            ...
                            noun *result_out, M38Status *evaluation_status)
{
    ...
    *evaluation_status = M38_STATUS_OK;
    ...
    if (!wave_build_record(body_fields, 4, &body)
        || !wave_result_build(WAVE_WIRE_POKE, body, result_out))
        return 0;
    (void)slot_index;
    return 1;
}
                                         ...
                                         const ResourceResultView **out_view)
{
    ...
    uint8_t wire_status = WAVE_WIRE_REFUSE;
    ResultOwner owner = M38_RESULT_OWNER_REFUSAL;
    uint32_t refusal_reason = WAVE_REASON_INVALID_REQUEST;
    ...
    if (request->operation == WAVE_OP_LOAD) {
        uint32_t catalog_index;
        if (!wave_core_index(runtime, session, request->first, &catalog_index)) {
            refusal_reason = WAVE_REASON_UNKNOWN_CORE;
            goto refuse;
        }
        WaveCacheEntry *cache = &session->cache[catalog_index];
        ...
        if (!cache->valid) {
            if (!wave_parse_plan(session->catalog[catalog_index].core, &staged_plan)) {
                refusal_reason = WAVE_REASON_CORE_FAILURE;
                goto refuse;
            }
        }
        uint32_t free_slot = WAVE_MAX_LIVE_HANDLES;
        for (uint32_t i = 0; i < WAVE_MAX_LIVE_HANDLES; i++)
            if (!session->slots[i].used) { free_slot = i; break; }
        if (free_slot == WAVE_MAX_LIVE_HANDLES) {
            refusal_reason = WAVE_REASON_NO_SLOT;
            goto refuse;
        }
    ...
    if (request->operation == WAVE_OP_SNAPSHOT) {
        if (!wave_handle_decode(session, request->first, &slot_index)
            || !wave_plan_for_slot(session, slot_index, &plan)) {
            refusal_reason = WAVE_REASON_BAD_HANDLE;
            goto refuse;
        }
        staged_slot = session->slots[slot_index];
        if (staged_slot.snapshot_nonce == WAVE_MAX_SNAPSHOT_NONCE) {
            refusal_reason = WAVE_REASON_BAD_SNAPSHOT;
            goto refuse;
        }
        ...
        if (!wave_result_build(WAVE_WIRE_SNAPSHOT, snapshot, &result)) {
            refusal_reason = WAVE_REASON_CONSTRUCTION;
            goto refuse;
        }
        staged_slot.snapshot_root = snapshot;
        wire_status = WAVE_WIRE_SNAPSHOT;
        owner = M38_RESULT_OWNER_PRIMARY;
        goto publish;
    }
    ...
    staged_slot = session->slots[slot_index];
    if (request->operation == WAVE_OP_POKE) {
        ...
        if (!wave_poke_result(session, slot_index, plan, request->second,
            ...
            refusal_reason = WAVE_REASON_BAD_STIMULUS;
            goto refuse;
        }
        staged_slot.state_root = state;
        wire_status = WAVE_WIRE_POKE;
        owner = M38_RESULT_OWNER_PRIMARY;
        goto publish;
    }
    if (request->operation == WAVE_OP_PEEK) {
        uint32_t target;
        if (!wave_selector_validate(plan, request->second, &target)) {
            refusal_reason = WAVE_REASON_BAD_SELECTOR;
            goto refuse;
        }
        ...
        if (!wave_observation_build(plan, target, &observation)
            ...
            || !wave_result_build(WAVE_WIRE_PEEK, body, &result)) {
            refusal_reason = WAVE_REASON_CONSTRUCTION;
            goto refuse;
        }
        wire_status = WAVE_WIRE_PEEK;
        owner = M38_RESULT_OWNER_PRIMARY;
        goto publish;
    }
    if (request->operation == WAVE_OP_RESTORE) {
        ...
        noun receipt;
        if (!wave_build_tagged(WAVE_RECEIPT_TAG, WAVE_RECEIPT_SCHEMA,
        ...
        if (!wave_build_record(body_fields, 3, &body)
            || !wave_result_build(WAVE_WIRE_RESTORE, body, &result)) {
            refusal_reason = WAVE_REASON_CONSTRUCTION;
            goto refuse;
        }
        staged_slot.state_root = state;
        wire_status = WAVE_WIRE_RESTORE;
        owner = M38_RESULT_OWNER_PRIMARY;
                                        ...
                                        const ResourceResultView **out_view)
{
    ...
    *out_view = 0;
    ...
    WaveRequest decoded;
    if (!wave_request_decode(request, &decoded)) return M38_STATUS_REQUEST_INVALID;
...
_Static_assert(sizeof(ResourceRuntime) <= WAVE_RUNTIME_CONTROL_BYTES,
               "ResourceRuntime exceeds its fixed control reservation");
_Static_assert(sizeof(ResourceSession) <= WAVE_SESSION_BYTES,
               "ResourceSession exceeds its fixed storage reservation");

#if defined(M38_D8_WAVE_A)
#include "uart.h"

static uint8_t g_wave_boot_control[WAVE_RUNTIME_CONTROL_BYTES]
    __attribute__((aligned(WAVE_STORAGE_ALIGNMENT)));
static uint8_t g_wave_boot_workspace[WAVE_RUNTIME_WORKSPACE_BYTES]
    __attribute__((aligned(WAVE_STORAGE_ALIGNMENT)));
static uint8_t g_wave_boot_session_a[WAVE_SESSION_BYTES]
    __attribute__((aligned(WAVE_STORAGE_ALIGNMENT)));
static uint8_t g_wave_boot_session_b[WAVE_SESSION_BYTES]
    __attribute__((aligned(WAVE_STORAGE_ALIGNMENT)));
static uint8_t g_wave_boot_jams[2][2][WAVE_MAX_CORE_JAM_BYTES]
    __attribute__((aligned(WAVE_STORAGE_ALIGNMENT)));
...
static uint32_t wave_boot_atom_bytes(noun atom)
{
    ...
    if (!stored) return 0;
    if (stored->size == 0 || stored->size > WAVE_MAX_CORE_JAM_BYTES / sizeof(uint64_t))
        return 0;
                                  ...
                                  uint32_t core_bytes_out[2])
{
    ...
    for (uint32_t i = 0; i < 2; i++) {
        ...
        if (record_bytes == 0 || core_bytes == 0
            || record_bytes > WAVE_MAX_RECORD_JAM_BYTES
            || core_bytes > WAVE_MAX_CORE_JAM_BYTES
...
static int wave_boot_make_request(uint32_t operation, noun args, noun *out)
{
    ...
    noun body;
    if (!wave_build_tagged(WAVE_REQUEST_TAG, WAVE_REQUEST_SCHEMA,
                           fields, 2, &body))
        return 0;
    *out = body;
    return 1;
...
static int wave_boot_result_body(const ResourceResultView *view, noun *body)
{
    ...
    if (!view || !view->root_slot || !wave_pair(*view->root_slot, &tag, &result_body)
        || !wave_atom_text(tag, WAVE_RESULT_TAG)
...
void m38_resource_wave_a_boot(void)
{
    ...
    noun request;
    heap_set_mode(HEAP_MODE_PERSIST);
    if (!wave_boot_make_request(WAVE_OP_LOAD, cores[0], &request)) return;
    ...
    noun_tx_commit();
    heap_set_mode(HEAP_MODE_PERSIST);
    if (!wave_boot_make_request(WAVE_OP_LOAD, cores[1], &request)) return;
    status = m38_resource_session_dispatch(session_b, request, &view);
    wave_boot_line("LOAD-B", status, view);

    noun stimulus, selector, poke_value, poke_values;
    if (!wave_value_build(2, 1, 1, &poke_value)
        || !wave_build_list(&poke_value, 1, &poke_values)) return;
    noun stimulus_fields[2] = {direct(1), poke_values};
    noun selector_fields[1] = {direct(1)};
    if (!wave_build_tagged(WAVE_STIMULUS_TAG, WAVE_STIMULUS_SCHEMA,
                           stimulus_fields, 2, &stimulus)
        || !wave_build_tagged(WAVE_SELECTOR_TAG, WAVE_SELECTOR_SCHEMA,
                              selector_fields, 1, &selector))
        return;
    view = 0;
    heap_set_mode(HEAP_MODE_PERSIST);
    if (!wave_boot_make_handle_request(session_a, WAVE_OP_POKE, 1, stimulus, &request)) return;
    status = m38_resource_session_dispatch(session_a, request, &view);
    wave_boot_line("POKE-A", status, view);
    view = 0;
    heap_set_mode(HEAP_MODE_PERSIST);
    if (!wave_boot_make_handle_request(session_b, WAVE_OP_PEEK, 1, selector, &request)) return;
    status = m38_resource_session_dispatch(session_b, request, &view);
    wave_boot_line("PEEK-B", status, view);
    view = 0;
    heap_set_mode(HEAP_MODE_PERSIST);
    if (!wave_boot_make_handle_request(session_a, WAVE_OP_SNAPSHOT, 1, NOUN_ZERO, &request)) return;
    status = m38_resource_session_dispatch(session_a, request, &view);
    ...
    if (status == M38_STATUS_OK && view) {
        ...
        if (wave_boot_result_body(view, &snapshot)) {
            view = 0;
            heap_set_mode(HEAP_MODE_PERSIST);
            if (wave_boot_make_handle_request(session_a, WAVE_OP_RESTORE, 1,
                                              snapshot, &request)) {
                status = m38_resource_session_dispatch(session_a, request, &view);
